...
output files matching the backtester2 snapshot naming convention:
...
in backtester2/snapshots/. The backtester2 engine works unchanged.

Usage:
    # Merge March 20–27 from recorder/data/ into backtester2/snapshots/
    python -m backtester2.tickrecorder.merge --from 2026-03-20 --to 2026-03-27

    # Custom source and output directories
    python -m backtester2.tickrecorder.merge \\
        --from 2026-03-20 --to 2026-03-27 \\
        --data-dir /opt/ct/recorder/data \\
        --output-dir backtester2/snapshots
"""
import argparse
import logging
import os
...
def _bt2_date(date_str):
    # type: (str) -> str
    """Convert YYYY-MM-DD to YYYYMMDD (backtester2 filename convention)."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Merge recorder daily parquets into a backtester2 range file."
    )
    ...
    parser.add_argument("--output-dir", default=None,
                        help="Output directory "
                             f"(default: backtester2/snapshots/)")
